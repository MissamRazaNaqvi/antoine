        ...
        <div className={pdpcss.pdpCard}>
            <div className={pdpcss.pdpCardView}>
                ...
                <div className={pdpcss.pdpCardContent}>
                    <span className={pdpcss.pdpTitle}>{product.title}</span>
                    <span className={pdpcss.pdpAuthor}>{product.author}</span>
                    <span className={pdpcss.pdpRating}>
                        <Rating size={15} fillColor='orange' emptyColor='gray' />
                    </span>
                    <div className={pdpcss.priceContainer}>
                        <span className={pdpcss.pdpPrice}>LBP {product.price}</span>
                        <span className={pdpcss.discountPrice}>{discountPrice}</span>
                        <span className={pdpcss.discount}>Save 50%</span>
                    </div>
                    <div className={pdpcss.quantity}>
                        <span className={pdpcss.qtyTitle}>Quantity</span>
                    ...
                    <div className={pdpcss.shareContainer}>
                        <button className={pdpcss.storeLocation}>
                            ...
                            </svg>Check in Store Availability</button>
                    ...
                    <p className={pdpcss.International}>For International: 1-2 days</p>
                ...
                <>
                    <div className={pdpcss.productInfo}>
                        <div className={pdpcss.infoBtn}>
                            <span onClick={() => { setIsActive(1) }} className={`${pdpcss.ProductDesc} ${isActive === 1 ? pdpcss.borderCss : ''}`}>Product Description</span>
                            <span onClick={() => { setIsActive(2) }} className={`${pdpcss.moreInfo} ${isActive === 2 ? pdpcss.borderCss : ''}`}>Additional Information</span>
                            <span onClick={() => { setIsActive(3) }} className={`${pdpcss.review} ${isActive === 3 ? pdpcss.borderCss : ''}`}>Reviews(19)</span>
                        </div>
                    ...
                    <div className={pdpcss.reviewContent}>
                        {isActive === 1 ?
                            <div className={pdpcss.ProductDescContent}>
                                ...
                                <ul>
                                    <li>“Taylor Jenkins Reid is the queen of queens when it comes to beach reads, and this breathtaking treat proves once again the throne is hers alone.” -Taylor</li>
                                    <li>“If you’re looking for a book to take on holiday this summer, The Seven Husbands of Evelyn Hugo has got all the glitz and glamour to make it a perfect read.” -Bustle</li>
                                </ul>
                            </div>
                            : ""}
                        {isActive === 2 ?
                            ...
                            <>
                                <div className={pdpcss.reviewContents}>
                                    <div className={pdpcss.review1}>
                                        ...
                                        <span className={pdpcss.reviews}>19 reviews</span>
                                    </div>
                                    ...
                                    <div className={pdpcss.feedback}>
                                        <div className={pdpcss.feedbackContent}>
                                            <span className={pdpcss.boughtedProduct}>Already bought this product?</span>
                                ...
                                <div className={pdpcss.customerReview}>
                                    ...
                                    <div className={pdpcss.comments}>
                                        <span className={pdpcss.ratingTitle}>Rating</span>
                                        <span>
