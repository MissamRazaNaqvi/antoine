...
export default function TrendingBook({ books, path, AddToCart }) {
    return (
        <div>
            <p className={style.bookTitle}>{!path === process.env.REACT_APP_API_BASEURL ? 'You may also like' : 'Trending in Books'} </p>
